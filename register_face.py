...
if __name__ == "__main__":
    ...
    for name in os.listdir(data_wajah):
        # print(name)
        name_path = os.path.join(data_wajah, name)

        for file in os.listdir(name_path):
            img_path = os.path.join(name_path, file)
        ...
        dict_face[name] = feature.tolist()

with open("result.json", "w") as outfile:
    json.dump(dict_face, outfile)
